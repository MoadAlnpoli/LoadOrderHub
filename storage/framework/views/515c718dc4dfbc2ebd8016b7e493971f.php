    ...
    <div class="glass-card rounded-2xl border border-slate-800 p-6 space-y-5">
        ...
        <div class="mt-8 pt-6 border-t border-slate-800 space-y-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <form action="<?php echo e(route('admin.maintenance.toggle')); ?>" method="POST" onsubmit="return confirm('<?php echo e(app()->isDownForMaintenance() ? 'Are you sure you want to disable maintenance mode?' : 'هل أنت متأكد من تفعيل وضع الصيانة؟ الموقع لن يكون متاحاً للزوار.'); ?>')">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\lravle\taskmn\resources\views/admin/partials/settings.blade.php ENDPATH**/ ?>