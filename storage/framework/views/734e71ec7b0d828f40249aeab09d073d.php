    ...
    <div class="glass-card rounded-2xl border border-slate-800 p-6 space-y-5">
        ...
        <div class="glass-card rounded-xl border border-slate-800 overflow-hidden mt-4">
            <div class="p-3 border-b border-slate-800 flex justify-between items-center">
                ...
                <span class="px-2 py-0.5 bg-slate-800 text-slate-300 rounded text-[10px]"><?php echo e(count($subscribers)); ?> مشترك</span>
            </div>
                ...
                <table class="w-full text-right text-xs">
                    ...
                    <tbody class="divide-y divide-slate-800/50">
                        ...
                        <tr class="hover:bg-slate-800/30">
                            <td class="px-4 py-3 font-mono text-slate-300"><?php echo e($sub->email); ?></td>
                            <td class="px-4 py-3 text-slate-500"><?php echo e($sub->created_at->format('Y-m-d H:i')); ?></td>
...
<?php /**PATH C:\lravle\taskmn\resources\views/admin/partials/newsletter.blade.php ENDPATH**/ ?>